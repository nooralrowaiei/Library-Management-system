...
if(isset($_POST['forgot_password'])){
	...
	if($count == 1){
		...
		$headers = "From : noor.alrowaiei00@gmail.com";
            ...
            $mail->setFrom(getenv('SMTP_USER'), 'Library Management System');
            $mail->addAddress($to);
            ...
            header('location: forgot_password.php?error=Password sent to your email');
        } catch (Exception $e) {
            header('location: forgot_password.php?error=Email failed: '.$mail->ErrorInfo);
        }
