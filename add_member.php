        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                if (isset($_POST['submit'])){
					...
					{		
						mysqli_query($con,"insert into user (roll_number,firstname, middlename, lastname, contact, gender, type, branch, user_added)
						values ('$roll_number','$firstname', '$middlename', '$lastname', '$contact', '$gender', '$type', '$branch', NOW())")or die(mysqli_error($con));
